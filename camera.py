...
classifier = load_model(f'{root_path}/pramesh3.h5')
...
class Video(object):
    ...
    def get_frame(self, reset_predictions):
        try:
            ...
            if success:
                faces = face_classifier.detectMultiScale(frame, 1.3, 5) #library classifier
                ...
                for x, y, w, h in faces:  #x,y coordinate,  w, h width height
                    ...
                    roi_gray = gray[y:y + h, x:x + w]  # change in gray scale
